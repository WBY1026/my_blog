    ...
    <span class="most-big-box">
        <span class="main-box">
            ...
            <span class="input">
                ...
                <el-input id="email" type="text" v-model="user.miniEmail" placeholder="请输入邮箱"></el-input><br>
...
<script>
	...
	export default {
		...
		methods: {
			LogIn(){
				// eslint-disable-next-line no-unused-vars
				AV.User.loginWithEmail(this.user.miniEmail, this.user.miniPassword).then((user) => {
                    console.log('登录成功')
