    ...
    <span class="most-big-box">
        <span class="main-box">
            ...
            <span class="input">
                ...
                <el-input id="email" type="text" v-model="user.miniPhoneNumber" placeholder="请输入手机号"></el-input><br>
...
<script>
	...
	export default {
		...
		methods: {
			LogIn(){
				// eslint-disable-next-line no-unused-vars
				AV.User.logInWithMobilePhone(this.user.miniPhoneNumber, this.user.miniPassword).then((user) => {
                    console.log('登录成功')
